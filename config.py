...
def get_args():
    ...
    parser.add_argument('--checkpoint-folder', metavar='DIR',
                        ...
                        default=r'D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master\checkpoint')
    ...
    parser.add_argument('--acc-steps', default=4, type=int, metavar='AccSteps',
    ...
    parser.add_argument('--pretrained-model', default=r'D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master\pretrained_models\model_casenet.pth.tar', type=str, metavar='PATH',
