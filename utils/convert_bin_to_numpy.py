...
if __name__ == "__main__":
    f = open("D:/marterial/daerchuyanfwk_detection/TRY-2/CASENet-master/cityscapes-preprocess/data_proc/train.txt", 'r')
    lines = f.readlines()
    root_folder = "D:/marterial/daerchuyanfwk_detection/TRY-2/CASENet-master/cityscapes-preprocess/data_proc"
    cnt = 0
