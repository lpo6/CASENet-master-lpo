...
def CASENet_resnet101(pretrained=False, num_classes=19):
    ...
    if pretrained:
        utils.load_official_pretrained_model(model, r"D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master/pretrained_models/model_casenet.pth.tar")
    return model

if __name__ == "__main__":
    model = CASENet_resnet101(pretrained=False, num_classes=19) # 19 classes for Cityscapes

    npy_folder = r"D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master/pretrained_models/"
    loaded_model_path = r"D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master/pretrained_models/model_casenet.pth.tar"
    layer_to_name_dict = gen_mapping_layer_name(model)
    load_npy_to_layer(model, layer_to_name_dict, npy_folder, loaded_model_path)
    
    # npy_folder = r"D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master/init_models/"
    # # loaded_model_path = r"D:\marterial\daerchuyanfwk_detection\TRY-2\CASENet-master/init_models/casenet_inst_init.pth.tar"
    # layer_to_name_dict = gen_mapping_layer_name(model)
    # load_npy_to_layer(model, layer_to_name_dict, npy_folder, loaded_model_path)
